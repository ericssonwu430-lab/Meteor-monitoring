    ...
    >
      <div className="shrink-0 border-b border-slate-800 px-3 py-2.5">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex gap-1.5">
            <button
              type="button"
              onClick={onSelectAll}
              className="rounded border border-slate-600 px-2 py-1 text-[10px] font-medium text-slate-300 hover:border-cyan-600 hover:text-cyan-300"
            >
              Select all
            </button>
            <button
              type="button"
              onClick={onClear}
              className="rounded border border-slate-600 px-2 py-1 text-[10px] font-medium text-slate-300 hover:border-amber-600 hover:text-amber-300"
            >
              Clear
            </button>
          </div>
        ...
        <p className="mt-1.5 text-[10px] leading-snug text-slate-500">
          Check meteors to show shooting-star trails on the globe.
        </p>
      </div>
            ...
            <li key={id}>
              <label
                className={`flex cursor-pointer items-start gap-2 rounded-lg px-2 py-1.5 transition-colors ${
                  checked
                    ? "bg-cyan-950/50 ring-1 ring-cyan-700/40"
              ...
              >
                <input
                  ...
                  className="mt-1 h-3.5 w-3.5 shrink-0 rounded border-slate-600 bg-slate-900 text-cyan-500 focus:ring-cyan-500/40"
                />
